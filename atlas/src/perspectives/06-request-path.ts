...
export const requestPath: Perspective = {
    ...
    [
      ...
      },
      {
        ...
        nodes: [
          ...
          { id: "metric", step: 12, label: "EstimatedInvocationCostUsd", sub: "dimension: PlatformId", color: SEMANTIC.aws },
  ...
  edges: [
    ...
    { from: "listener", to: "extproc", label: "reads model from body", color: SEMANTIC.security },
    { from: "extproc", to: "rule", label: "sets x-ai-eg-model", color: SEMANTIC.platform },
